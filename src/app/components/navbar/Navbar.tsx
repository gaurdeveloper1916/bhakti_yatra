...
const Navbar = () => {
    return (
        <nav className="fixed top-0 left-0 z-50 w-full lg:h-28 h-24 bg-white/10 backdrop-blur-md shadow-md">
            <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center py-1 h-full">
                    <Link href="/" className="flex items-center gap-2">
                        <img src="/logo.png" alt="Logo" className="lg:h-24 h-20 w-auto" />
                    </Link>
